...
const routes: Routes = [
  ...
  {path: 'home', component: HomeComponent, children: [
    {path: 'asset-map', component: AssetMapComponent, data: { animation: 'asset-map' },},
    {path: 'all-asset-alerts', component: AllAssetAlertsComponent, data: { animation: 'all-asset-alerts' }},
    {path: 'asset-status', component: AssetStatusComponent, data: { animation: 'asset-status' }},
    ...
    {path: 'system-developer', component: SystemDevelopmentComponent, data: { animation: 'system-delopment' }}
  ], data: { animation: 'home' }},
];
